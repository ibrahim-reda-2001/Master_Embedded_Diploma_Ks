...
#define SPI1_index     				 0
#define SPI2_index      			 1
#define SPI_SR_TXE      			 (0x02) //it is mask value
#define SPI_SR_RXNE     			 (0x01)//it is mask value
...
void MCAL_SPI_Receive_Data(SPI_TypeDef* SPIx,u16* ptBuffer ,Polling_spi_mechnism PollingEn);
void MCAL_SPI_TX_RX(SPI_TypeDef* SPIx, u16* ptBuffer ,Polling_spi_mechnism PollingEn);
